 ...
 * @author kenyi
 */
public class Idex extends javax.swing.JFrame {
    ...
    public Index() {
        ...
        initComponents();
        this.setLocationRelativeTo(null);//para ubicar la ventana en el centro
        this.setTitle("Molinos COMOLSA");// titulos de la ventana
        llenarTabla();
    }

    /**
     * Creates new form Idex
     */
    public Idex() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombres", "Estado Civil", "Cantidad de horas", "Valor por hora", "Sueldo Bruto", "Descuento SNP", "Bonificación Familiarl", "Sueldo Neto"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Idex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
